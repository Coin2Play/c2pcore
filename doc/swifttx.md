...
This mechanism has been integrated into Bitcore-Node-Coin2Play which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Coin2Play-Project/insight-api-coin2play#web-socket-api](https://github.com/Coin2Play-Project/insight-api-coin2play#web-socket-api) 
* API: [https://github.com/Coin2Play-Project/insight-api-coin2play#swifttx-transactions](https://github.com/Coin2Play-Project/insight-api-coin2play#swifttx-transactions) 
...
By default, the Coin2Play Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Coin2Play Core daemon:
