...
In order to support loading of multiple wallets in coin2play-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is coin2play.cpp.
...
Changes to coin2play.cpp
----------------------
coin2play.cpp is the entry point into coin2play-qt, and as such, will require some minor modifications to provide hooks for
