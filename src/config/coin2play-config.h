/* src/config/coin2play-config.h.  Generated from coin2play-config.h.in by configure.  */
/* src/config/coin2play-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.coin2play.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Coin2Play Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Coin2Play Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "coin2play"
