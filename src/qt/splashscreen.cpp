...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("Coin2Play Core");
    QString versionText = QString(tr("Version v1.0.0-MAINNET")).arg(QString::fromStdString(FormatFullVersion()));
	...
	QString copyrightTextC2p = QChar(0xA9) + QString(tr(" 2018 The LightPayCoin Core developers"));
	...
	pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextC2p);
