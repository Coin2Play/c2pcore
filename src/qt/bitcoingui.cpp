                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Coin2Play Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Coin2Play address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and coin2play: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Coin2Play Core"), this);
    aboutAction->setStatusTip(tr("Show information about Coin2Play Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Coin2Play"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Coin2Play addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Coin2Play addresses"));
    ...
    openAction->setStatusTip(tr("Open a Coin2Play: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Coin2Play Core help message to get a list with possible Coin2Play command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Coin2Play Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Coin2Play network", "", count));
}
...
{
    QString strTitle = tr("Coin2Play Core"); // default title
