...
/** Utility functions used by the Coin2Play Qt UI.
 */
namespace GUIUtil
{
...
// Render Coin2Play addresses in monospace font
...
// Parse "coin2play:" URI into recipient object, return true on successful parsing
