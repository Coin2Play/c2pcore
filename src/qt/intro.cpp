...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Coin2Play Core"),
     ...
     * override -datadir in the coin2play.conf file in the default data directory
     * (to be consistent with coin2playd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
