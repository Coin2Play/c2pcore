...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total coin2play balance of the wallet\n"
            "  \"obfuscation_balance\": xxxxxx, (numeric) the anonymized coin2play balance of the wallet\n"
            ...
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in coin2play/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in coin2play/kb\n"
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"coin2playaddress\"\n"
            "\nReturn information about the given coin2play address.\n"
            "\nArguments:\n"
            "1. \"coin2playaddress\"     (string, required) The coin2play address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"coin2playaddress\", (string) The coin2play address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: Coin2Play address and we have full public key:
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are coin2play addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) coin2play address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"coin2playaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"coin2playaddress\"  (string, required) The coin2play address to use for the signature.\n"
