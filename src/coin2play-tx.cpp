...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Coin2Play Core coin2play-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  coin2play-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded coin2play transaction") + "\n" +
                               "  coin2play-tx [options] -create [commands]   " + _("Create hex-encoded coin2play transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded coin2play transaction
