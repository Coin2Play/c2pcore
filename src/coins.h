...
/** 
    ...
    ****Note - for Coin2Play we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of coin2play coming in to a transaction
