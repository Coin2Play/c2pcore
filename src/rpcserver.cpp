...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Coin2Play server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Coin2Play server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Coin2Play features */
        {"coin2play", "masternode", &masternode, true, true, false},
        {"coin2play", "listmasternodes", &listmasternodes, true, true, false},
        {"coin2play", "getmasternodecount", &getmasternodecount, true, true, false},
        {"coin2play", "masternodeconnect", &masternodeconnect, true, true, false},
        {"coin2play", "masternodecurrent", &masternodecurrent, true, true, false},
        {"coin2play", "masternodedebug", &masternodedebug, true, true, false},
        {"coin2play", "startmasternode", &startmasternode, true, true, false},
        {"coin2play", "createmasternodekey", &createmasternodekey, true, true, false},
        {"coin2play", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"coin2play", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"coin2play", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"coin2play", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"coin2play", "getmasternodescores", &getmasternodescores, true, true, false},
        {"coin2play", "mnbudget", &mnbudget, true, true, false},
        {"coin2play", "preparebudget", &preparebudget, true, true, false},
        {"coin2play", "submitbudget", &submitbudget, true, true, false},
        {"coin2play", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"coin2play", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"coin2play", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"coin2play", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"coin2play", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"coin2play", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"coin2play", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"coin2play", "checkbudgets", &checkbudgets, true, true, false},
        {"coin2play", "mnsync", &mnsync, true, true, false},
        {"coin2play", "spork", &spork, true, true, false},
        {"coin2play", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"coin2play", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use coin2playd, or the -server option to coin2play-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> coin2play-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2222/\n";
}
