...
!define COMPANY "Coin2Play Core project"
...
VIAddVersionKey ProductName "Coin2Play Core"
...
Section -Main SEC0000
    ...
    # Remove old wxwidgets-based-coin2play executable and locales:
    Delete /REBOOTOK $INSTDIR\coin2play.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\coin2play-qt.exe
    ...
    WriteRegStr HKCR "coin2play" "URL Protocol" ""
    WriteRegStr HKCR "coin2play" "" "URL:Coin2Play"
    WriteRegStr HKCR "coin2play\DefaultIcon" "" $INSTDIR\coin2play-qt.exe
    WriteRegStr HKCR "coin2play\shell\open\command" "" '"$INSTDIR\coin2play-qt.exe" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\coin2play-qt.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMSTARTUP\Coin2Play.lnk"
